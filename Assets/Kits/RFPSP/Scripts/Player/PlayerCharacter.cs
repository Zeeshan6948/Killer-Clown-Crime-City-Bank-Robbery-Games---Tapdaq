...
public class PlayerCharacter : MonoBehaviour {
    ...
    private SkinnedMeshRenderer[] fpBodySkinnedMeshes;
    ...
    void Start () {
        ...
        //zeeshan Chnages
        fpBodySkinnedMeshes = fpBodyObj.GetComponentsInChildren<SkinnedMeshRenderer>();
        foreach (SkinnedMeshRenderer abc in fpBodySkinnedMeshes)
        {
            abc.enabled=false;
        }
